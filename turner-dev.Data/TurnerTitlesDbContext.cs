...
namespace turner_dev.Data
{
    public partial class TurnerTitlesDbContext : DbContext
    {
        public TurnerTitlesDbContext()
        {
        }

        public TurnerTitlesDbContext(DbContextOptions<TurnerTitlesDbContext> options)
            : base(options)
        {
        }
